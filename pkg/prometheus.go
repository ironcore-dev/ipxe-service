...
var (
	requestIPXEDuration = prometheus.NewHistogramVec(prometheus.HistogramOpts{
		...
		Help:    "Histogram for the runtime of a simple ipxe(getChainByMac) function.",
	...
	requestIGNITIONDuration = prometheus.NewHistogramVec(prometheus.HistogramOpts{
		...
		Help:    "Histogram for the runtime of a simple ignition(getIgnitionByMacAndUUID) function.",
		Buckets: prometheus.LinearBuckets(0.01, 0.05, 10),
	},
		[]string{"mac"},
	)
